...
SELECT UserID, UserName, Email, Age FROM Users WHERE (UserID = @UserID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[2].CommandText = "INSERT INTO [dbo].[Users]  ([UserName], [Email], [Age]) VALUES (@UserName, @Email" +
                ", @Age)";
            ...
            this._commandCollection[3].CommandText = "UPDATE [dbo].[Users] SET [UserName] = @UserName, [Email] = @Email, [Age] = @Age W" +
